                  ...
                  child: Form(
                      ...
                      child: ListView(children: [
                        ...
                        buildTextField(
                            labelText: 'Prénom',
                            placeholder:
                                ctlHome.driver.value.prenom ?? 'Mesman',
                            isPasswordTextField: false,
                            controller: ctlProfile.lnameTF.value),
                        buildTextField(
                            labelText: 'Téléphone',
                            placeholder: ctlHome.driver.value.telephone ??
                                '+2250101010101',
                            isPasswordTextField: false,
                          ...
                          ctlProfile.isPasswordEditing.value
                              ? Padding(
                                  ...
                                  child: TextFormField(
                                      maxLength: 6,
                                      controller:
                                          ctlProfile.confirmpasswordTC.value,
                                      validator: (value) {
                                        if (value!.isNotEmpty &&
                                            value.toString().length == 6) {
                                          if (ctlProfile.confirmpasswordTC.value
                                                  .text !=
                                              ctlProfile
                                                  .passwordTC.value.text) {
