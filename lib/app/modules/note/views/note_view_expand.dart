...
import '../controllers/note_controller.dart' show NoteController;

class NoteExpandView extends GetView<NoteController> {
  @override
                          ...
                          for (var i = 0; i < ctlNote.noteList.length; i++)
                            InkWell(
                              onTap: () {
                                ...
                                if (ctlNote.noteList[i].details!.length == 1) {
                    ...
                    child: CupertinoButton(
                      onPressed: () async {
                        ctlNote.isSendingNote.value
                            ...
                            : null;
                        await ctlNote.postNotationsToApi().then((value) {
                          if (value == "succes") {
