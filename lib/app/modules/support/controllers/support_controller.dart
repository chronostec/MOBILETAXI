...
import 'package:alfred_taxi_client/app/data/models/message_support_model.dart';
import 'package:alfred_taxi_client/app/data/models/objet_message_model.dart';
...
class SupportController extends GetxController {
  ...
  Future getMessageObjet() async {
    ...
    messageObjetsList = await provMsgSupp .getObjetMessage();
  ...
  Future<MessageSupport> postMessage(
    ...
    message.value = await provMsgSupp.postMessageSupport(
